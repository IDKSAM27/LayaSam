...
def start_detection():
    ...
    predictor = dlib.shape_predictor(r"C:\Users\layap\Downloads\Drowsiness_Detection - Copy\Drowsiness_Detection - Copy\FinalProject\shape_predictor_68_face_landmarks.dat")
